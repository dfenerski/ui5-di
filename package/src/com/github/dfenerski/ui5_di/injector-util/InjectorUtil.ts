...
function getIsDependencyClassInjectionToken<T extends object>(
...
export class InjectorUtil {
    ...
    public static resolveInjectionToken<T extends object>({
        dependencyClass,
        drs,
        primitiveToken,
    ...
    public static normalizeSettleToken<T extends object>(
